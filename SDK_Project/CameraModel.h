...
protected:
	...
	// private properties
	const EdsUInt32 PropID_DC_Zoom = 0x00000600;
	const EdsUInt32 PropID_DC_Strobe = 0x00000601;
	const EdsUInt32 PropID_LensBarrelStatus = 0x00000605;

	const EdsUInt32 PropID_TempStatus = 0x01000415;
	const EdsUInt32 PropID_Evf_RollingPitching = 0x01000544;
	const EdsUInt32 PropID_FixedMovie = 0x01000422;
	const EdsUInt32 PropID_MovieParam = 0x01000423;
	const EdsUInt32 PropID_Aspect = 0x01000431;

	const EdsUInt32 PropID_Evf_ClickWBCoeffs = 0x01000506;
	const EdsUInt32 PropID_Evf_VisibleRect = 0x01000546;
	const EdsUInt32 PropID_ManualWhiteBalanceData = 0x01000204;

	const EdsUInt32 PropID_MirrorUpSetting = 0x01000438;
	const EdsUInt32 PropID_MirrorLockUpState = 0x01000421;

	const EdsUInt32 PropID_UTCTime = 0x01000016;
	const EdsUInt32 PropID_TimeZone = 0x01000017;
	const EdsUInt32 PropID_SummerTimeSetting = 0x01000018;

	const EdsUInt32 PropID_AutoPowerOffSetting = 0x0100045e;

	const EdsUInt32 PropID_StillMovieDivideSetting = 0x01000470;
	const EdsUInt32 PropID_CardExtension = 0x01000471;
	const EdsUInt32 PropID_MovieCardExtension = 0x01000472;
	const EdsUInt32 PropID_StillCurrentMedia = 0x01000473;
	const EdsUInt32 PropID_MovieCurrentMedia = 0x01000474;
	const EdsUInt32 PropID_MovieHFRSetting = 0x0100045d;
	const EdsUInt32 PropID_FocusShiftSetting = 0x01000457;
